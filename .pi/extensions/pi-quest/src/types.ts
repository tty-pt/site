...
export interface ExtensionAPI {
  ...
  registerEntryRenderer<T = any>(
    type: string,
    renderer: (entry: any, o: any, theme: any) => any,
  ): void;
...
export interface StoredState {
  ...
  firstPlanReviewFired?: boolean;
  _lastSemanticKey?: string;
  lastThought?: string;
  __lastDraftReviewKey?: string;
  __lastPlanReviewKey?: string;
  __lastDirectionReviewKey?: string;
