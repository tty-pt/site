import type { AgentObligation, CompactionTransaction, PendingAgentNotification, PendingResume, PendingSubquestResumeResolution } from "../types.ts";
...
export function reconstructPendingResume(pendingResume: any): PendingResume | null {
	...
	return {
		...
		checkpointSaveCount: typeof pendingResume.checkpointSaveCount === "number" ? Number(pendingResume.checkpointSaveCount) : (undefined as any),
		checkpointHash: typeof pendingResume.checkpointHash === "string" ? String(pendingResume.checkpointHash) : (undefined as any),
		checkpointQuestPath: typeof pendingResume.checkpointQuestPath === "string" ? String(pendingResume.checkpointQuestPath) : (undefined as any),
...
function mapNotification(n: any): PendingAgentNotification {
	return {
		...
		details: n.details,
		stateGeneration: typeof n.stateGeneration === "number" ? n.stateGeneration : undefined,
		planVersion: typeof n.planVersion === "number" ? n.planVersion : undefined,
		reassessmentVersion: typeof n.reassessmentVersion === "number" ? n.reassessmentVersion : undefined,
		correlationId: typeof n.correlationId === "string" ? n.correlationId : undefined,
		...
		fulfilledReason: typeof n.fulfilledReason === "string" ? n.fulfilledReason : undefined,
		supersededAt: typeof n.supersededAt === "number" ? n.supersededAt : undefined,
		supersededReason: typeof n.supersededReason === "string" ? n.supersededReason : undefined,
		cancelledAt: typeof n.cancelledAt === "number" ? n.cancelledAt : undefined,
		cancelledReason: typeof n.cancelledReason === "string" ? n.cancelledReason : undefined,
		failedAt: typeof n.failedAt === "number" ? n.failedAt : undefined,
		failedReason: typeof n.failedReason === "string" ? n.failedReason : undefined,
...
export function reconstructObligationHistory(history: any): AgentObligation[] {
	...
	return history.map((n: any) => ({
		...
		code: String(n.code || ""),
		message: String(n.message || ""),
		status: n.status || (n.fulfilledAt ? "fulfilled" : n.superseded ? "superseded" : "pending"),
		deliverAs: n.deliverAs || "followUp",
		requiredNextAction: n.requiredNextAction,
		details: n.details,
		stateGeneration: typeof n.stateGeneration === "number" ? n.stateGeneration : undefined,
