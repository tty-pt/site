...
export function reconstructActiveTransaction(
  ...
  return {
    ...
    questPath:
      typeof txData.questPath === "string" ? txData.questPath : undefined,
    reason: txData.reason || "normal-compaction",
    checkpointSaveCount:
      typeof txData.checkpointSaveCount === "number"
        ? txData.checkpointSaveCount
        : undefined,
    checkpointHash:
      typeof txData.checkpointHash === "string"
        ? txData.checkpointHash
        : undefined,
    observedSaveCount:
      typeof txData.observedSaveCount === "number"
        ? txData.observedSaveCount
        : undefined,
    observedHash:
      typeof txData.observedHash === "string" ? txData.observedHash : undefined,
    observedQuestPath:
      typeof txData.observedQuestPath === "string"
    ...
    completedAt:
      typeof txData.completedAt === "number" ? txData.completedAt : undefined,
...
export function reconstructPendingResume(
  ...
  return {
    ...
    checkpointSaveCount:
      typeof pendingResume.checkpointSaveCount === "number"
        ? Number(pendingResume.checkpointSaveCount)
        : undefined,
    checkpointHash:
      typeof pendingResume.checkpointHash === "string"
        ? String(pendingResume.checkpointHash)
        : undefined,
    checkpointQuestPath:
      typeof pendingResume.checkpointQuestPath === "string"
    ...
    lastAttemptAt:
      typeof pendingResume.lastAttemptAt === "number"
        ? pendingResume.lastAttemptAt
        : undefined,
    deliveredAt:
      typeof pendingResume.deliveredAt === "number"
...
function mapNotification(n: any): PendingAgentNotification {
  return {
    ...
    details: n.details,
    stateGeneration:
      typeof n.stateGeneration === "number" ? n.stateGeneration : undefined,
    planVersion: typeof n.planVersion === "number" ? n.planVersion : undefined,
    reassessmentVersion:
      typeof n.reassessmentVersion === "number"
        ? n.reassessmentVersion
        : undefined,
    correlationId:
      typeof n.correlationId === "string" ? n.correlationId : undefined,
    dedupKey: typeof n.dedupKey === "string" ? n.dedupKey : undefined,
    attempts: Number(n.attempts || 0),
    createdAt: Number(n.createdAt || Date.now()),
    lastAttemptAt:
      typeof n.lastAttemptAt === "number" ? n.lastAttemptAt : undefined,
    ...
    fulfilledReason:
      typeof n.fulfilledReason === "string" ? n.fulfilledReason : undefined,
    supersededAt:
      typeof n.supersededAt === "number" ? n.supersededAt : undefined,
    supersededReason:
      typeof n.supersededReason === "string" ? n.supersededReason : undefined,
    cancelledAt: typeof n.cancelledAt === "number" ? n.cancelledAt : undefined,
    cancelledReason:
      typeof n.cancelledReason === "string" ? n.cancelledReason : undefined,
    failedAt: typeof n.failedAt === "number" ? n.failedAt : undefined,
    failedReason:
      typeof n.failedReason === "string" ? n.failedReason : undefined,
