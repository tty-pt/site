...
export function findProjectRoot(startDir?: string): string {
	...
	return resolve(startDir || (typeof process !== "undefined" ? process.cwd() : "."));
}
...
export function findExtensionDir(projectRoot: string, explicitDir?: string): string {
	...
	return resolve(dirname(dirname(import.meta.url ? new URL(import.meta.url).pathname : (typeof process !== "undefined" ? process.cwd() : "."))));
}
