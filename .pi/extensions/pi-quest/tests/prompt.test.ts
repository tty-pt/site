...
async function testQuestJournalPromptInjection() {
	...
	assert.ok(injected.includes("quest_mark_saved"), "Should reference quest_mark_saved tool");
	assert.ok(injected.includes("quest_subquest"), "Should reference quest_subquest tool");
