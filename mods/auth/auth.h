...
NDX_HOOK_DECL(int, item_record_ownership, const char *, item_path, const char *, username);
...
NDX_HOOK_DECL(int, item_read_owner, const char *, item_path, char *, out, size_t, outlen);
