...
typedef int (*item_handler_cb)(int fd, char *body, const item_ctx_t *ctx,
                               void *user);
...
NDX_HOOK_DECL(int, item_record_ownership, const char *, item_path, const char *,
              username);

/* Check if username owns item_path.
 * When root: compare stat uid. When non-root: read owner file. */
NDX_HOOK_DECL(int, item_check_ownership, const char *, item_path, const char *,
              username);

NDX_HOOK_DECL(item_access_t, item_access_status, const char *, item_path,
              const char *, username, unsigned, flags);
NDX_HOOK_DECL(int, item_require_access, int, fd, const char *, item_path,
...
NDX_HOOK_DECL(int, item_read_owner, const char *, item_path, char *, out,
              size_t, outlen);
...
NDX_HOOK_DECL(int, item_ctx_load, item_ctx_t *, ctx, int, fd, const char *,
              items_path, unsigned, flags);

NDX_HOOK_DECL(int, with_item_access, int, fd, char *, body, const char *,
