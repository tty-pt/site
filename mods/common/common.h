...
NDX_HOOK_DECL(int, respond_plain, int, fd, int, status, const char *, msg);
...
NDX_HOOK_DECL(int, bad_request,  int, fd, const char *, msg);  /* 400; NULL -> "Bad request" */
...
NDX_HOOK_DECL(int, json_array_append_raw,
