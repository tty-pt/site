...
extern struct RenderResult
ssr_render_delete_ffi(const struct DeleteRenderFfi *req);

extern void ssr_free_result_ffi(struct RenderResult *result);

extern struct RenderResult
ssr_render_choir_detail_ffi(const struct ChoirDetailRenderFfi *req);

extern struct RenderResult
ssr_render_poem_detail_ffi(const struct PoemRenderFfi *req);

extern struct RenderResult
ssr_render_poem_edit_ffi(const struct PoemRenderFfi *req);

extern struct RenderResult
ssr_render_song_detail_ffi(const struct SongDetailRenderFfi *req);

extern struct RenderResult
ssr_render_songbook_detail_ffi(const struct SongbookDetailRenderFfi *req);
