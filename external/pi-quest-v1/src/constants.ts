...
export const RETRY_MAX_TURNS_DEFAULT = 5;
export const ENV_RETRY_MAX_TURNS = "PI_QUEST_RETRY_MAX_TURNS";
export const RETRY_DELIVER_AS_DEFAULT = "nextTurn";
export const ENV_RETRY_DELIVER_AS = "PI_QUEST_RETRY_DELIVER_AS";
