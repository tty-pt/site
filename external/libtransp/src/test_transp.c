...
TEST(music_key_helpers)
{
	/* key_name(semitones, orig_key, latin) */
	assert(strcmp(key_name(0, 0, 0), "C (Original)") == 0);
	assert(strcmp(key_name(2, 0, 0), "D (+2)") == 0);
	assert(strcmp(key_name(-2, 0, 0), "Bb (-2)") == 0);
	assert(strcmp(key_name(0, 0, 1), "Do (Original)") == 0);
	assert(strcmp(key_name(2, 0, 1), "Re (+2)") == 0);

	/* target_key_name(orig_key, transpose, latin) */
	assert(strcmp(target_key_name(0, 0, 0), "C") == 0);
	assert(strcmp(target_key_name(0, 2, 0), "D") == 0);
	assert(strcmp(target_key_name(0, 1, 0), "Db") == 0);
	assert(strcmp(target_key_name(0, 1, 1), "Reb") == 0);
	assert(strcmp(target_key_name(0, 0, 1), "Do") == 0);
}
