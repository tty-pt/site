...
PORT=${PORT:-8080}
export LD_LIBRARY_PATH="$HOME/libqllm/lib:$SCRIPT_DIR/external/libxylem/lib:$SCRIPT_DIR/external/axil/lib:$SCRIPT_DIR/external/axil-auth/lib:$SCRIPT_DIR/external/axil-hyle/lib:$SCRIPT_DIR/external/hyle/lib:$SCRIPT_DIR/external/libtransp/lib:$SCRIPT_DIR/external/hyle/c/libhyle-bud/lib:$SCRIPT_DIR/external/hyle/c/libhyle-source/lib:$SCRIPT_DIR/external/bud/lib:$SCRIPT_DIR/external/libqmap/lib:$SCRIPT_DIR/external/libstoma/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}"
